...
class Subscription(ObjectBase):
    ...
    def customer_id(self):
        ...
        The customer_id is not available as a direct subscription
        property, but we need it to implement various features that need
        it. The only option is to extract it from the link.
        """
        url = self._get_link("customer")
    ...
    def payments(self):
        ...
        return SubscriptionPayments(
            self.client, customer=customer, subscription=self
        )
