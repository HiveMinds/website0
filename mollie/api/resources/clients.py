...
class Clients(ResourceListMixin, ResourceGetMixin):
    ...
    Retrieve a list of Mollie merchants connected to your partner
    account (only for Mollie partners).
    """
    ...
    def get(self, resource_id: str, **params: Any) -> Client:
        """Retrieve a single client, linked to your partner account, by its
        ID."""
